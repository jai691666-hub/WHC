...
const ProfileScreen = ({navigation}) => {
  ...
  const [course, setCourse] = useState('Please Choose Your Course');
        ...
        <LinearGradient colors={['#c44611', '#eb5312']} style={styles.header}>
          ...
          <TouchableOpacity
            ...
            <Image
              source={{
                uri: isMale
                  ? 'https://static.vecteezy.com/system/resources/thumbnails/035/914/352/small_2x/ai-generated-3d-cartoon-man-in-white-suit-businessman-character-on-transparent-background-png.png'
